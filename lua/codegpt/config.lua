...
local function file_exists(file)
	return lfs.attributes(file, "mode") ~= nil
end

local GPTPath = vim.fn.expand("$HOME") .. "Documents/Dev/GPTAPIKey.txt.gpg"
if file_exists(GPTPath) ~= nil then
	vim.g["codegpt_openai_api_key"] = "gpg --decrypt " .. GPTPath
end
